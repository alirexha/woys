    ...
    def start(self):
        ...
        while True:
            if self.settings.serverAudioStated == 0 or self.settings.serverInputDeviceId == -1:
                ...
                # vcclient-cachy is Linux-only; WASAPI exclusive-mode handling
                # (Windows-specific) has been removed. Linux audio routing goes
                # through PipeWire via the dedicated module under src/audio/.
