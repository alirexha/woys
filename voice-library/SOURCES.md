...
Models are NOT bundled in this repo (per `LICENSE` / brief §7). They live in `~/.local/share/vcclient-cachy/models/` on the user's machine. This file documents the upstream HuggingFace URL + slug for each.
...
| `alfred_pennyworth` | Alfred Pennyworth (Arkham) | ✅ | <https://huggingface.co/Homiebear/AlfredPennyworth_465e_8835s/resolve/main/AlfredPennyworth_465e_8835s.zip> |
...
| `batman_troy_baker` | Batman / Bruce Wayne (Troy Baker, Telltale) | ✅ | <https://huggingface.co/Zogii/zogiiRVC/resolve/main/Bruce%20Wayne%20(Troy%20Baker)%20Batman%20The%20Telltale%20Series%20(RVC%20v2)%20400%20Epochs.zip> |
